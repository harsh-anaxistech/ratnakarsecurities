...
export const metadata = generatePageMetadata({
  title: "Terms of Conditions :: Ratnakar Securities Limited.",
  description: "Terms of Conditions of Ratnakar Securities Limited.",
        ...
        <Container>
          <nav aria-label="Breadcrumbs" className="mb-4 relative z-10">
            <ol className="flex items-center gap-2 text-sm text-gray-400 p-0 m-0 list-none">
              ...
              <li className="text-secondary font-medium" aria-current="page">Terms of Conditions</li>
            </ol>
          </nav>
      ...
      <section className="py-12 md:py-16">
        <Container>
          <div className="bg-slate-50 rounded-3xl shadow-[0_20px_50px_-15px_rgba(0,0,0,0.06)] border border-black/5 p-4 sm:p-8 md:p-12 space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 mb-6">Terms and Conditions of Use</h2>
            <p className="text-[16px] text-slate-600 leading-relaxed font-medium">
              Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern Ratnakar Securities Limited's relationship with you in relation to this website.
            </p>
            <p className="text-[16px] text-slate-600 leading-relaxed font-medium">
