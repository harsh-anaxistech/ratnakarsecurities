                ...
                <div className="flex-1 min-w-[260px] relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-2 border border-border rounded-md text-sm placeholder:text-muted-foreground outline-none focus:border-[#004b87] focus-visible:outline-2 focus-visible:outline-[#004b87] focus-visible:outline-offset-2 transition-all bg-muted/20 [&::-webkit-search-cancel-button]:hidden [&::-webkit-search-decoration]:hidden"
                    />
                    {searchTerm && (
                      <button
                        type="button"
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="bg-white border border-border rounded-md px-2.5 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm font-semibold outline-none focus:border-[#004b87] focus-visible:outline-2 focus-visible:outline-[#004b87] focus-visible:outline-offset-2 cursor-pointer hover:border-gray-400 transition-colors"
                    >
