        ...
        <div className="w-full lg:w-[62%] p-4 sm:p-8 md:p-12 flex flex-col justify-center">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-end pt-2">
              ...
              <div className="bg-gray-100 border border-border rounded-sm px-5 py-2 select-none tracking-[0.4em] font-mono text-lg text-muted-foreground text-center font-bold shadow-inner h-12 flex items-center justify-center">
                IO3YLY
              </div>
            </div>
