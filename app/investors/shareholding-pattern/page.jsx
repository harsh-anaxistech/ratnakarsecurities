...
/**
 * Shareholding Pattern Disclosures Page Component
 * 
 * Fetches and displays promoter, public, and institutional shareholding distribution disclosures
 * via `getInvestorDocuments("Shareholding Pattern")`.
 */
        ...
        <Container>
          <div className="mb-12 text-center">
            ...
            <p className="text-[16px] text-gray-700 max-w-3xl mx-auto font-medium">
              View and download our statutory shareholding pattern filings.
            </p>
          </div>
                      ...
                      group.files.map((file) => {
                        ...
                        return (
                          <a
                            ...
                            download
                            aria-label={`Download document: ${file.caption || "Shareholding Pattern"}`}
