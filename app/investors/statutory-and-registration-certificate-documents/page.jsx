        ...
        <Container>
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-serif tracking-tight text-slate-950 leading-tight mb-4">
              Statutory & Registration Certificate Documents
            </h2>
            <p className="text-[16px] text-gray-700 max-w-3xl mx-auto font-medium">
              View and download our regulatory licenses, SEBI registration certificates, and statutory incorporation documents.
            </p>
          </div>
              ...
              {documents.map((file) => {
                ...
                return (
                  <a
                    ...
                    download
                    aria-label={`Download document: ${file.caption || file.filename || "Statutory Document"}`}
