...
export default async function PoliciesPage() {
  let groupedData = [];
  try {
    const response = await getInvestorDocuments("Policies");
        ...
        <Container>
          <div className="mb-12 text-center">
            ...
            <p className="text-[16px] text-gray-700 max-w-3xl mx-auto font-medium">
              Access and download our corporate governance policies, codes of conduct, and terms.
            </p>
          </div>
                      ...
                      group.files.map((file) => {
                        ...
                        return (
                          <a
                            ...
                            download
                            aria-label={`Download document: ${file.caption || "Policy Document"}`}
