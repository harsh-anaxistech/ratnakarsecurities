        ...
        <Container>
          <div className="mb-12 text-center">
            ...
            <p className="text-[16px] text-gray-700 max-w-3xl mx-auto font-medium">
              View and download material events and information disclosures.
            </p>
          </div>
          ...
          {groupedData.length === 0 ? (
            <div className="text-center py-20 bg-white border border-gray-100 rounded-2xl shadow-sm">
              ...
              <h3 className="text-lg font-bold text-gray-900">No disclosures found</h3>
              <p className="text-gray-600 mt-2 font-medium">
                There are currently no disclosures available for viewing.
              </p>
            </div>
          ) : (
                      ...
                      group.files.map((file) => {
                        ...
                        return (
                          <a
                            ...
                            download
                            aria-label={`Download document: ${file.caption || "Disclosure Document"}`}
