    ...
    <div className="bg-[#f7f9fc] min-h-screen pb-16">
      ...
      <Container className="mt-12">
        <div className="bg-white rounded-3xl border border-black/5 shadow-sm p-6 sm:p-10 md:p-12 space-y-6 max-w-4xl mx-auto">
          ...
          <h3 className="text-xl font-bold text-[#a7181e] mb-6">At Ratnakar, We Care!</h3>
          ...
          <ul className="list-disc pl-6 space-y-3 text-[16px] text-[#314158] leading-relaxed marker:text-[#a7181e]">
          ...
          <div className="bg-[#f7f9fc] p-6 md:p-8 rounded-2xl border border-black/5 mt-10 flex items-start gap-4">
            <div className="w-10 h-10 rounded-xl bg-[#fee2e2] flex items-center justify-center shrink-0 mt-1">
              <MapPin className="w-5 h-5 text-[#a7181e]" />
            </div>
            <div>
