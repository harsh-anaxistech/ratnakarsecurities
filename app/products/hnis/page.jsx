      ...
      <Container className="mt-12">
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-[70%] bg-white rounded-2xl shadow-sm border border-black/5 p-5 md:p-10">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-6" style={{ color: "#0f172a" }}>HNI Investment Solutions</h3>
                ...
                {faqs.map((faq, idx) => (
                  ...
                  >
                    <button
                      ...
                      aria-controls={`hnis-faq-panel-${idx}`}
                    ...
                    {openIndex === idx && (
                      <div
                        id={`hnis-faq-panel-${idx}`}
                        role="region"
                        aria-labelledby={`hnis-faq-btn-${idx}`}
            ...
            >
              ...
              <p style={{ color: "#334155" }}>
                <strong className="font-bold text-slate-900" style={{ color: "#0f172a" }}>Disclaimer:</strong> Investments are subject to market risks. HNI Services do not guarantee returns or protect against losses. Investors should evaluate their financial goals and risk tolerance before investing.
              </p>
            </div>
            ...
            <div className="pt-8 border-t border-black/5">
              ...
              >
                {product.buttonText || "Consult Our HNI Advisors"} <ArrowRight className="w-5 h-5" aria-hidden="true" />
              </Link>
            </div>
          </div>
