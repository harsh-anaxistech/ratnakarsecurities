            ...
            <div className="bg-white p-6">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = "#3DDC84"; e.currentTarget.style.background = "rgba(61,220,132,0.06)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(0,0,0,0.10)"; }}
                  onMouseLeave={e => { e.currentTarget.style.borderColor = "#f0f0f0"; e.currentTarget.style.background = "#fff"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; }}
                >
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: "rgba(61,220,132,0.12)" }}>
                  ...
                  <div className="text-center">
                    <p className="text-[10px] font-semibold tracking-widest uppercase text-gray-400 mb-0.5">GET IT ON</p>
                    <p className="text-base font-bold text-gray-900">Google Play</p>
                    <p className="text-xs text-gray-500 mt-0.5">Android</p>
                  </div>
                  <div className="flex items-center gap-1.5 rounded-full px-4 py-1.5" style={{ background: "#ea2830" }}>
                ...
                <a
                  ...
                  className="flex-1 flex flex-col items-center gap-3 rounded-2xl p-5 border-2 transition-all duration-200"
                  style={{ borderColor: "#f0f0f0", background: "#fff" }}
                  onMouseEnter={e => { e.currentTarget.style.borderColor = "#aaaaaa"; e.currentTarget.style.background = "rgba(0,0,0,0.04)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(0,0,0,0.10)"; }}
                  onMouseLeave={e => { e.currentTarget.style.borderColor = "#f0f0f0"; e.currentTarget.style.background = "#fff"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; }}
                >
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: "rgba(0,0,0,0.06)" }}>
                    <svg viewBox="0 0 24 24" className="w-9 h-9" fill="#444">
                      <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
                    </svg>
                  </div>
                  <div className="text-center">
                    <p className="text-[10px] font-semibold tracking-widest uppercase text-gray-400 mb-0.5">DOWNLOAD ON THE</p>
                    <p className="text-base font-bold text-gray-900">App Store</p>
                    <p className="text-xs text-gray-500 mt-0.5">Apple iOS</p>
                  </div>
                  <div className="flex items-center gap-1.5 rounded-full px-4 py-1.5" style={{ background: "#ea2830" }}>
                    <Download style={{ width: "13px", height: "13px", color: "#fff" }} />
                    <span className="text-white text-xs font-semibold">Download</span>
