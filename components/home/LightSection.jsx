      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex flex-col items-start p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <a href="/plans" className="inline-flex items-center gap-1 text-[#a7181e] font-semibold hover:underline">
          ...
          <div className="flex flex-col items-start p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <a href="/insights" className="inline-flex items-center gap-1 text-[#a7181e] font-semibold hover:underline">
