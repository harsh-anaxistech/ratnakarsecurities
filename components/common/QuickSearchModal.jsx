    ...
    >
      ...
      >
        ...
        <div className="flex items-center px-4 py-3.5 border-b border-slate-200 gap-3">
          <Search className="w-5 h-5 text-slate-700 shrink-0" aria-hidden="true" />
          ...
          <input
            ...
            className="flex-1 text-[16px] text-slate-900 placeholder:text-slate-600 bg-transparent outline-none"
          />
          <button
            type="button"
            onClick={onClose}
            aria-label="Close search dialog"
            className="w-8 h-8 rounded-lg flex items-center justify-center text-slate-700 hover:text-slate-900 hover:bg-slate-100 transition-colors"
          >
        ...
        <div className="max-h-96 overflow-y-auto p-2" role="listbox" aria-label="Search results">
          {filteredItems.length === 0 ? (
            <div className="p-8 text-center text-slate-700">
              ...
              <p className="text-xs text-slate-700 mt-1">Try searching for keywords like Equity, SIP, Grievance, or Charter.</p>
            </div>
          ) : (
        ...
        <div 
          className="px-4 py-2.5 border-t border-slate-200 flex items-center justify-between text-xs text-slate-700"
        ...
        >
          ...
          <span className="font-bold text-[#004f7a]">Ratnakar Quick Finder</span>
        </div>
      </div>
    </div>
  );
