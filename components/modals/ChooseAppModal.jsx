  ...
  const apps = [
    {
      ...
      btnBg: "#166534",
      iconSvg: (
        <svg viewBox="0 0 24 24" width="28" height="28" fill="#166534">
    ...
    },
    {
      ...
      btnBg: "#004f7a",
      iconSvg: (
        <svg viewBox="0 0 24 24" width="28" height="28" fill="#004f7a">
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 max-w-[60%]">
            ...
            <p className="text-[12px] mt-1 leading-relaxed text-slate-100 font-medium">
          ...
          <button
            onClick={onClose}
            className="absolute top-2.5 right-2.5 flex items-center justify-center w-7 h-7 rounded-full transition-all duration-200 cursor-pointer z-20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            style={{ background: "rgba(255,255,255,0.2)", color: "#fff" }}
            aria-label="Close download mobile app dialog"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-3.5">
            {apps.map((app) => (
              <a
                ...
                className="flex-1 flex flex-col items-center gap-2.5 rounded-2xl p-4 border-2 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#004f7a]"
              ...
              >
                ...
                <div className="text-center">
                  <p className="text-[10px] font-bold tracking-widest uppercase text-slate-700 mb-0.5">
                    {app.badge}
                  </p>
                  <p className="text-sm font-bold text-slate-900">{app.label}</p>
                  <p className="text-[11px] text-slate-700 font-medium">{app.name}</p>
                </div>

                <div
                  className="flex items-center gap-1 rounded-full px-4 py-1.5 mt-0.5 shadow-xs"
                  style={{ background: app.btnBg, color: "#ffffff" }}
                >
                  <Download style={{ width: "12px", height: "12px", color: "#ffffff" }} />
                  <span className="text-white text-[11px] font-bold">Download</span>
                </div>
              </a>
            ))}
          </div>
