  ...
  const apps = [
    {
      ...
      btnBg: "#15803d",
      iconSvg: (
        <svg viewBox="0 0 24 24" width="28" height="28" fill="#15803d">
    ...
    },
    {
      ...
      btnBg: "#006da0",
      iconSvg: (
        <svg viewBox="0 0 24 24" width="28" height="28" fill="#006da0">
            ...
            {apps.map((app) => (
              ...
              >
                ...
                <div className="text-center">
                  <p className="text-[9px] font-bold tracking-widest uppercase text-gray-600 mb-0.5">
                    {app.badge}
                  </p>
                  <p className="text-sm font-bold text-gray-900">{app.label}</p>
                  <p className="text-[11px] text-gray-600">{app.name}</p>
                </div>
