      ...
      >
        ...
        <div className="relative pt-2.5 px-4 pb-1">
            ...
            >
              <defs>
                <linearGradient id="header-grad-sm" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#003859" />
                  <stop offset="50%" stopColor="#004f7a" />
                  <stop offset="100%" stopColor="#006399" />
                </linearGradient>
              </defs>
              <path
          ...
          <div className="relative z-10 flex justify-end items-center">
            <button
              onClick={onClose}
              className="flex items-center gap-1 text-[11px] font-bold tracking-wider text-slate-800 hover:text-slate-950 transition-colors group cursor-pointer bg-white px-2.5 py-1 rounded-full shadow-xs border border-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#004f7a]"
              aria-label="Close popup"
            >
              <span>CLOSE</span>
              <span className="w-5 h-5 rounded-full bg-slate-100 group-hover:bg-slate-200 flex items-center justify-center text-slate-700 transition-colors">
          ...
          <div className="relative z-10 flex justify-center -mt-1 mb-1.5">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white p-1 shadow-md border border-slate-100 flex items-center justify-center">
              <div className="w-full h-full rounded-full bg-[#004f7a] flex items-center justify-center text-white shadow-inner" style={{ backgroundColor: "#004f7a" }}>
          ...
          <div className="relative z-10 text-center px-1">
            <h2 id="risk-disclosure-modal-title" className="text-base sm:text-lg font-black tracking-tight text-[#004f7a]">
              RISK DISCLOSURES <span className="text-[#0f172a] font-extrabold">ON DERIVATIVES</span>
            </h2>

            {/* Subtitle Divider with Center Dot */}
            <div className="flex items-center justify-center gap-2 my-2">
              <div className="w-8 sm:w-10 h-[1.5px] bg-slate-300 rounded-full"></div>
              <div className="w-1.5 h-1.5 rounded-full bg-[#004f7a]"></div>
              <div className="w-8 sm:w-10 h-[1.5px] bg-slate-300 rounded-full"></div>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 sm:px-5 pb-4 space-y-3" style={{ backgroundColor: "#ffffff" }}>
          {/* Main 4 Points Box */}
          ...
          <div className="bg-[#f0f7ff] border border-[#cce3fc] rounded-xl p-2.5 sm:p-3 flex items-start gap-2.5 shadow-xs" style={{ backgroundColor: "#f0f7ff" }}>
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[#dbeafe] text-[#004f7a] flex items-center justify-center shrink-0 mt-0.5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="none"
            ...
            <div>
              <h3 className="font-bold text-[#004f7a] text-xs sm:text-sm mb-0.5">
                Source:
              </h3>
              <p className="text-[#334155] text-[10.5px] sm:text-[11.5px] leading-relaxed font-normal">
